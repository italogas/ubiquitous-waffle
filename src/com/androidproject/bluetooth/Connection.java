...
//        mContext.bindService(intent, mServiceConnection, Context.BIND_AUTO_CREATE);
        ...
        Intent serviceIntent = new Intent(mContext,ConnectionService.class);
        mContext.bindService(serviceIntent, mServiceConnection, Context.BIND_AUTO_CREATE);//startService(serviceIntent);
